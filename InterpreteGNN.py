...
parser.add_argument("-m", "--model", type=int, default=0, help="model type: 0:GCN, 1:GAT, 2:GAT_Edge, 3:GATv2, 4:SAGE")
parser.add_argument("-o", "--object", type=int, default=0, help="decoding object: 0:drug, 1:cell_line")
...
model = [GCNNet(), GATNet(), GATNet_E(), GATv2Net(), SAGENet()][model_type]
model_name = ['GCN', 'GAT', 'GAT_Edge', 'GATv2', 'SAGE'][model_type]
...
decoding_type = ['Drug', 'CellLine'][decoding_object]
